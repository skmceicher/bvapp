...
import com.mukul.assignment.models.Data;
...
public class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.ViewHolder> {
    ...
    public HomeAdapter(Context context, List<Data> data, OnItemClickListener listener) {
        this.data = data;
    ...
    public void onBindViewHolder(HomeAdapter.ViewHolder holder, int position) {
        ...
        holder.tvDesc.setText(data.get(position).getDesignation().getName());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void click(final Data cityListData, final OnItemClickListener listener) {
